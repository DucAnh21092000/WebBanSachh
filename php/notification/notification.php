...
<tr>
<td colspan=1></td>
<td class="d-flex justify-content-center"><button name="submit" type="submit" class="btn btn-info" >Add Message</button></td>
</tr>
</table>
<?php
require_once ('../notification/xulythemthongbao.php');
?>
</form>
</div>
