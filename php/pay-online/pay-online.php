                           ...
                           <li class="nav-item" style="height: 20px;list-style:none">
                               <a style="margin-top:-12px" class="nav-link dropdown-toggle" href="#" id="dropdownId" 
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <b> <?php echo "Xin chào ".$_SESSION['fullname']." !" ?> </b>
                               </a>
               ...
               <div class="pay-body__header-info d-flex flex-column justify-content-center ">
                <form action="pay-online.php?id=<?=$_GET['id']?>" method="POST">
                    ...
                    <div class="input-group form-pay d-flex col-sm-10 ">
                        ...
                        <input type="text " name="phone" id="phone" value="<?=$_SESSION['phone'] ?>" class="form-control " placeholder=" " aria-describedby="prefixId ">
                    </div>

                    <div class="input-group form-pay d-flex col-sm-10">
                        <span class="col-sm-3 input-group-addon " id="prefixId ">Email:</span>
                        <input type="text " name="email" id="emalil " value="<?=$_SESSION['email'] ?>" class="form-control " placeholder=" " aria-describedby="prefixId ">
                    </div>
        ...
        if(isset($_POST['a'])){
            ...
            if($sql_oder){
                echo "<script>
                      ...
                      window.location.replace('../pay-online/pay-online.php?id=".$_GET['id']."');
                      </script>";
            } 
           }
