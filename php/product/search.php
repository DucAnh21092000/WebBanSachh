    ...
    <div class="header">
        ...
        <div class="header-logo container d-flex justify-content-between ">
            ...
            <div class="col-md-4 d-flex flex-row align-items-end">
                <input type="text" onkeydown="confirm(this)" style="height: 30px;" name="" id="input-search" class="form-control" value="" placeholder="Tìm kiếm..." required="required" title="">
    ...
    <div class="body d-flex flex-column">
     ...
     <div class="product">
         ...
         <ul>
          <?php  
            include ('../../connect.php');
            $query = "select * from product where name like '%".$_GET['name']."%'";
            $pr = mysqli_query($connect,$query);
