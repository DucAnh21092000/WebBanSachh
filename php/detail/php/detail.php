...
<head>
    ...
    <link rel="stylesheet" href="../css/chat.css" class="">
...
<div class="header">
    ...
    <div class="body d-flex flex-column">
       ...
       <div class=" flex-row d-flex">
                ...
                <input style="width:50px;height:20px;margin-left:10px" type="text" id="number-product"  class="form-control" title="">
      
        </div>
        <small  class="error-label text-danger">Bạn cần nhập số lượng đặt mua!</small>
        <button onclick="goToCart(<?=$_GET['id']?>)" id="submit-cart" name="cart" type="button" class="btn btn-primary" style="margin-top:30px;width:200px"> <i style="margin-left:-27px" class="fa fa-cart-arrow-down" aria-hidden="true"></i> &nbsp Mua sản phẩm </button>
        ...
        <form >
         ...
         <img src="../image/arrleft.png" alt="" class="moreLeft" onclick="morebook()">
          ...
          <a class="linkBook"><img alt="Picture1" class="morebook"></a> 
          <a class="linkBook"><img alt="Picture2" class="morebook"></a> 
          <a class="linkBook"><img alt="Picture3"  class="morebook"></a> 
          <a class="linkBook"><img alt="Picture4"  class="morebook"></a> 
          <a class="linkBook"><img alt="Picture5"  class="morebook"></a> 
          <a class="linkBook"><img alt="Picture6"  class="morebook"></a> 
          </div>
...
<?php break;         
    ...
    <!-- Scroll top -->
   <div>
<img src="../image/arrowTop.png" onclick="scrolltop()" alt="" class="scrollTop">
   </div>
  ...
  <!-- form chat -->
 <img src="../image/mess.png" width="3%" style="position: fixed; bottom: 0px; right:50px;" onclick="showFormChat(<?=$_SESSION['user_id']?>,<?=$_GET['id']?>)" alt="" class="">
  <div class="chat col-sm-3 col-xxl-9 displayNone">
        <div  class=" col-sm-12 col-lg-12 col-md-12 col-xl-12 d-flex flex-column-reverse ">
            <div class="form-chat col-sm-12 col-lg-12 col-xl-12 col-lg-12 col-md-4 " style="border: 1px solid black ;">
                <div class="chat-menu d-flex flex-row">
                        <div class=""><b class="">ADMIN </b></div>
                        <div class="d-flex justify-content-end col-lg-11" >
                                 <div class="hident-chat mr-2 "> <i class="fa fa-minus " aria-hidden="true "></i> &nbsp; </div>
                                 <div class="close-chat ml-1 "> <i class="fa fa-times " aria-hidden="true "></i> &nbsp; </div>
                        </div>
                </div>  
                <div class="">Đức Anh</div>  
                <div class="backgroundFormChat" > 
                    <div class="message col-lg-12 col-sm-12 ">
                    </div>
                    
                </div>
                <form action="" class="" method="POST">
                    <div class=" col-sm-12 col-lg-12" style="background-color: white;">
                         <input type="text " class=" formSubmit input-chat form-control" name=" " id=" " aria-describedby="helpId " placeholder=" ">
                         <img class="btn-sendMessage " src=" ../image/sendMessage.png " onclick="sendMess(<?=$_SESSION['user_id']?>,<?=$_GET['id']?>)">
                    </div>
                </form>                
